...
#ifndef MODEL3DVIEW_Stacking_H
#define MODEL3DVIEW_Stacking_H
...
class Stacking : public Dali::ConnectionTracker {
public:
    explicit Stacking(Dali::Application &application);

    ~Stacking() override = default;
...
private:
    ...
    std::vector<std::shared_ptr<PhysicsObject> > mDockList;
